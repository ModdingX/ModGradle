...
import org.moddingx.modgradle.plugins.cursedep.CurseDepPlugin;
import org.moddingx.modgradle.plugins.packdev.task.BuildCursePackTask;
import org.moddingx.modgradle.plugins.packdev.task.BuildModrinthPackTask;
import org.moddingx.modgradle.plugins.packdev.task.BuildServerPackTask;
import org.moddingx.modgradle.plugins.packdev.task.BuildTargetTask;
...
public class PackDevPlugin implements Plugin<Project> {
    ...
    public void apply(@Nonnull Project project) {
        ...
        if (!project.getPlugins().hasPlugin("org.moddingx.modgradle.mapping"))
