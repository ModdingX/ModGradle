...
public class CurseDependencyExtension extends GroovyObjectSupport {
    ...
    public Dependency pack(int projectId, int fileId, List<Object> excludes) {
        ...
        if (file == null) {
            ...
            if (entry == null) throw new IllegalStateException("Can't create curse ModPack dependency: Pack file contains no manifest.");
            ...
            reader.close();
            Configuration configuration = this.project.getConfigurations().create("cursepack_" + projectId + "_" + fileId + "_" + new Random().nextInt(1000));
